...
class MainSongScreen extends StatefulWidget {
  const MainSongScreen(
      {required this.songmodel_savn,
      required this.songurl,
      required this.songthumb});
  final String? songurl;
  final String? songthumb;
  final Song songmodel_savn;
  @override
  MainSongScreenState createState() => MainSongScreenState();
}

class MainSongScreenState extends State<MainSongScreen>
