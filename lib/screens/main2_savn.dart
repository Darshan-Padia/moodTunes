...
class MainSongScreen2 extends StatefulWidget {
  const MainSongScreen2(
      {required this.songurl, required this.songthumb, required this.songname});
  final List<dynamic>? songurl;
  final String? songname;
  final String? songthumb;
  @override
  MainSongScreen2State createState() => MainSongScreen2State();
}

class MainSongScreen2State extends State<MainSongScreen2>
  ...
  void initState() {
    ...
    songlink = widget.songurl![0]["link"]!;
    a1 = AudioSource.uri(
      Uri.parse(songlink),
      tag: MediaItem(
        id: '${_nextMediaId++}',
    ...
    //   statusBarColor: Colors.black,
    // ));
    // songlink = widget.songmodel_savn.downloadUrls[2].link;
    // a1 = AudioSource.uri(
    //   Uri.parse(songlink),
    //   tag: MediaItem(
    //     id: '${_nextMediaId++}',
    ...
    //     artUri: Uri.parse(
    //       widget.songmodel_savn.images[2].link,
    //     ),
    //   ),
    // );
    // // _player.play(); // Add this line to start playing when the screen opens
